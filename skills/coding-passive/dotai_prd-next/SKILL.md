...
8. **Update Progress** - Prompt user to run /swe-prd-update-decsions
...
- **PRD-specific commands used** - Recent use of `/swe-prd-update-decsions`, `/swe-prd-start` with specific PRD
...
To update PRD progress and commit your work, run `/swe-prd-update-decsions`.

---

Then STOP. Do not proceed further. The `/swe-prd-update-decsions` command handles PRD updates, progress tracking, and commits. This separation ensures proper workflow and avoids duplicate/conflicting updates.
