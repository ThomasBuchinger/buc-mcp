...
When a term is resolved, update `.agents/CONTEXT.md` right there. Don't batch these up — capture them as they happen. Use the format in `@skill:matpocock-grillme/resources/CONTEXT-FORMAT.md`
